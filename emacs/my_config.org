...
* Dependencies
  ...
  #+BEGIN_SRC emacs-lisp
        ...
        (ensure-package-installed 'all-the-icons 'company 'company-c-headers 'company-irony-c-headers 'company-go 'company-irony 'company-jedi 'elscreen 'emmet-mode 'go-snippets 'irony 'js2-mode 'markdown-mode 'neotree 'org-bullets 'yasnippet 'yasnippet-snippets 'web-mode)
