...
* Dependencies
  ...
  #+BEGIN_SRC emacs-lisp
        ...
        (ensure-package-installed 'company 'company-c-headers 'company-irony-c-headers 'company-go 'company-irony 'company-jedi 'elscreen 'emmet-mode 'go-snippets 'irony 'js2-mode 'markdown-mode 'neotree 'yasnippet 'yasnippet-snippets 'web-mode)
