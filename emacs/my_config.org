...
* Dependencies
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (defun install-dependencies ()
      (ensure-package-installed 'apropospriate-theme 'all-the-icons 'company 'company-c-headers 'company-irony-c-headers 'company-go 'company-irony 'company-jedi 'elscreen 'emmet-mode 'go-snippets 'gradle-mode 'irony 'js2-mode 'markdown-mode 'neotree 'org-bullets 'org-kanban 'spaceline 'spaceline-all-the-icons 'use-package 'yasnippet 'yasnippet-snippets 'web-mode)
      (package-initialize))
